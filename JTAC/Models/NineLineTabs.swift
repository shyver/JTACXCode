...
enum NineLineTabs {
    ...
    static let all: [NineLineTab] = [
        ...
        .init(id: "situationUpdate", title: "SITUATION UPDATE", shortTitle: "S.UPDATE", jtacCategoryKey: "S. UPDATE"),
        .init(id: "gamePlan", title: "GAME PLAN", shortTitle: "G.PLAN", jtacCategoryKey: "GamePlan"),
