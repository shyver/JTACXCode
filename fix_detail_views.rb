...
blocks_to_replace = {
"NineLineBriefDetailView" => """struct NineLineBriefDetailView: View {
...
"SafetyOfFlightDetailView" => """struct SafetyOfFlightDetailView: View {
    @ObservedObject var jtacViewModel: JTACViewModel
    var isCompact: Bool = false
...
"SituationUpdateDetailView" => """struct SituationUpdateDetailView: View {
    @ObservedObject var jtacViewModel: JTACViewModel
    var isCompact: Bool = false
...
"GamePlanDetailView" => """struct GamePlanDetailView: View {
    @ObservedObject var jtacViewModel: JTACViewModel
    var isCompact: Bool = false
...
"RemarksDetailView" => """struct RemarksDetailView: View {
    @ObservedObject var jtacViewModel: JTACViewModel
    var isCompact: Bool = false
...
"RestrictionsDetailView" => """struct RestrictionsDetailView: View {
    @ObservedObject var jtacViewModel: JTACViewModel
    var isCompact: Bool = false
...
"BDADetailView" => """struct BDADetailView: View {
    @ObservedObject var jtacViewModel: JTACViewModel
    var isCompact: Bool = false
...
# The regex strategy: look for "struct X: View { ... }" up to the next "struct" or end of file
blocks_to_replace.each do |name, repl|
  # Match from `struct Name: View {` up to `\n}\n\nstruct`, or `\n}\n\n//`, or end of file
  content.gsub!(/struct\s+#{name}\s*:\s*View\s*\{.*?\n\}\n(?=\n*struct|\z)/mo, repl + "\n")
end
